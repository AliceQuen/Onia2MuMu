...
process.mkcands = cms.EDAnalyzer('MultiLepPAT',
    ...
    KeepAllSingleObjectCandsInMC = cms.untracked.bool(False),
    SkipCompositeCandBuildingWhenKeepingSingles = cms.untracked.bool(False),
    Debug_Output = cms.untracked.bool(False),
    DebugMask = cms.untracked.uint32(0),
