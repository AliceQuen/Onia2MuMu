...
'/store/data/Run2025C/ParkingDoubleMuonLowMass1/MINIAOD/PromptReco-v1/000/392/672/00000/2385875f-1d5b-4a77-9b5b-20af338aefd2.root'
)
...
# 21Jan2025 chiw ("Eric"): The 'eventsToProcess' will limit the range of events to be processed. The 'fileNames' will be ignored.
process.source = cms.Source("PoolSource",
    skipEvents=cms.untracked.uint32(0),
	fileNames = cms.untracked.vstring(ivars.inputFiles),
	# eventsToProcess = cms.untracked.VEventRange("392672:1058438295-392672:1059438295")
)
